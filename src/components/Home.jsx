...
function Home() {
    ...
    const handleClick = () => {
        ...
        //filter ke andar, one by one hame sare products milte hain  
        //locally search karna hai to aise karenge=^ , lekin api se search karna hai to aise bhi kar sakye =>
                    ...
                    cproducts.map((item, index) => {
                        ...
                        return (
                            <div key={item._id} className="card m-3 ">
                                ...
                                <img width="250px" height="200px" src={API_URL + '/' + item.pimage} />
                                {/* to join image we need : in backend index.js   */}
